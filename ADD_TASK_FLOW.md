...
### Step 4: User Submits → Frontend POSTs to Backend
...
```json
{
  "id": 3,  // ← Auto-generated by json-server
  "title": "Complete project proposal",
  "description": "Finish Q1 proposal",
  "priority": "high",
  "dueDate": "2026-02-15",
...
case "ADD_TASK":
  return {
    ...state,
    tasks: [...state.tasks, action.payload]  // ← Task added to array
  };
```
...
### Step 9: Browser Refresh → Task Still There (PERSISTENCE)
